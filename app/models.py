...
class User(db.Model, UserMixin):
    ...
    def to_dict(self): # You can't add the class itself into a dicitonary, so we have to create a method to return the values of the attributes of the class as a dictionary
        # almost every single model will have a to_dict method when you are passing information through http requests
        return {
            'id': self.id,
            'email': self.email,
